...
//! not conjured for the ones it lacks. Eleven of the entries here are **`false`**, and they are
...
pub const TABLE: &[(&str, &str, bool)] = &[
    ...
    ("__has_attribute", "__returns_twice__", true),
    ("__has_attribute", "no_sanitize_address", true),
    ("__has_attribute", "__no_sanitize_address__", true),
    ("__has_attribute", "copy", true),
    ("__has_attribute", "__copy__", true),
    ("__has_attribute", "symver", true),
    ("__has_attribute", "__symver__", true),
