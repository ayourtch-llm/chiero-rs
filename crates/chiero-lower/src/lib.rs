            ...
            self.emit(
                InstKind::Assign {
                    ...
                    rv: RValue::Bin {
                        ...
                        ty: CTy::Int(32),
                        // `_Bool` is unsigned, but C promotes it to `int` before the increment
                        // and the value is 0 or 1, so this addition is signed and cannot overflow.
                        signed: true,
                    },
                },
                span,
                ...
                self.emit(
                    InstKind::Assign {
                        ...
                        rv: RValue::Bin {
                            ...
                            ty: CTy::Int(64),
                            // **Address arithmetic chiero generated, not arithmetic the program
                            // wrote.** Scaling an index by the element size is unsigned by nature
                            // -- addresses are -- and marking it signed would report the engine's
                            // own pointer math as the user's signed overflow.
                            signed: false,
                        },
                    },
                    span,
            ...
            self.emit(
                InstKind::Assign {
                    ...
                    rv: RValue::Bin {
                        ...
                        b: bi,
                        ty: CTy::Int(64),
                        // Two addresses subtracted, before the division that makes it a
                        // `ptrdiff_t`. Unsigned for the same reason as the scaling above.
                        signed: false,
                    },
                },
                span,
            ...
            self.emit(
                InstKind::Assign {
                    ...
                    rv: RValue::Bin {
                        ...
                        ty: CTy::Int(64),
                        // `SDiv` already carries its signedness in the opcode; the field is
                        // redundant here and agrees with it rather than contradicting it.
                        signed: true,
                    },
                },
                span,
        ...
        self.emit(
            InstKind::Assign {
                ...
                rv: RValue::Bin {
                    ...
                    ty: CTy::Int(64),
                    // Generated address arithmetic -- see `array_index` above.
                    signed: false,
                },
            },
            span,
            ...
            self.emit(
                InstKind::Assign {
                    ...
                    rv: RValue::Bin {
                        ...
                        ty: CTy::Int(64),
                        // Negating a generated byte offset, not a value the program named.
                        signed: false,
                    },
                },
                span,
...
fn float_bits(k: chiero_cir::FloatKind, v: f64) -> u128 {
    match k {
        ...
        self.emit(
            InstKind::Assign {
                ...
                rv: RValue::Bin {
                    ...
                    ty: CTy::Int(1),
                    // A conjunction of two `i1` comparison results: no C operand, no sign.
                    signed: false,
                },
            },
            span,
